...
namespace Microsoft.Azure.Management.ContainerRegistry.Fluent.Models
{
    ...
    public partial class FileTaskStep : TaskStepProperties
    {
        ...
        public FileTaskStep(string taskFilePath, IList<BaseImageDependency> baseImageDependencies = default(IList<BaseImageDependency>), string contextPath = default(string), string valuesFilePath = default(string), IList<SetValue> values = default(IList<SetValue>))
